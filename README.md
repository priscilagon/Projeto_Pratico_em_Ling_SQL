...
Realizar Prática Profissional Supervisionada de modelagem de dados em SGBD’;
Configurar sistemas operacionais e seus recursos necessários para o uso de banco de dados;
Composição de Relatório Final de Atividades.
...
Perceber-se eficiente para utilizar bem os recursos;
Concentrar-se na realização das atividades e evitar as distrações;
Aproximar-se da equipe para manter contato social;
Demonstrar tolerância para resolver problemas;
...
# Referência básica:
ALVES, William Pereira. Banco de Dados: Teoria e Desenvolvimento. 2. ed. Editora: Érica. 2020.
HEUSER, Carlos Alberto. Projeto de Banco de Dados. 6.ed. Editora: Bookman, 2009.
PUGA, Sandra. FRANÇA, Edson. GOYA, Milton. Banco de dados implementação em SQL, PL/SQL e Oracle 11g. 1.ed. Editora: Person, 2013.

# Referência Complementar:
MANZANO, José Augusto N. Z. Microsoft SQL Server 2012 Express. Guia Prático e Interativo. Editora: Érica. 2012.
Microsoft MySQL Server. Disponível em: < https://www.microsoft.com/pt-br/sql-server/sql-server-downloads>. Acesso em: 10/12/2021.
MILANI, André. Construindo Aplicações Web com PHP e MySQL. 2. ed. Editora: NOVATEC, 2010.
